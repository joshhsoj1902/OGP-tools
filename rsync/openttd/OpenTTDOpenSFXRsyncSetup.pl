...
#use strict;
package OpenTTD::OpenTTDOpenSFXRsyncSetup;
...
&download_file("$downloadurl", "$workingdir/opensfx.zip");

#My unAchive doesn't like this file...
my $systemCommand = "unzip -o $workingdir/opensfx.zip -d $basesetdir;"; 
...
my $systemCommand = "mv -f $basesetdir/opensfx-* $basesetdir/opensfx";
my $exitStatus = system($systemCommand);
